...
class VampirKöylü extends Command {
    ...
    async run(message, args, perm) {
        ...
        if (!args[0]) return this.client.yolla("Rol verme biçimini belirt ve tekrar dene. \`Örnek kullanım: .vk sorumlu @hayp034/ID - .vk cezalı @hayp034/ID\`", message.author, message.channel)
